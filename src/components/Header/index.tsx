  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-5 items-center xl:justify-between ease-out duration-200 ${stickyMenu ? "py-4" : "py-6"}`}
        >
          {/* <!-- header top left --> */}
              ...
              <div className="flex items-center">
                <div className="relative w-full">
                  <input
                    ...
                    className="w-full rounded-r-[5px] bg-gray-1 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                  />
                  <button
                    id="search-btn"
                    aria-label="Search"
